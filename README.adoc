...
module "ecs_service" {
  ...
  // true, if you need the ability to deploy to preview environments (increases complexity)
...
link:examples/without-preview-support/[Without Preview Support]::
Simple service where Preview support is disabled.
